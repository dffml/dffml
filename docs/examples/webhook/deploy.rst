...
.. note::
    ...
    `examples/ffmpeg <https://github.com/dffml/dffml/blob/main/examples/ffmpeg/>`_
...
to be output to. An example video is available `here <https://github.com/dffml/dffml/raw/main/examples/ffmpeg/input.mp4>`_ .
