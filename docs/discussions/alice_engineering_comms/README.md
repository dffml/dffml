# Alice Engineering Comms 🪬

This directory contains a `git grep -i` friendly format of
https://github.com/intel/dffml/discussions/1406?sort=new

These are the engineering logs of entities working on Alice. If you
work on [Alice](https://github.com/dffml/dffml/tree/main/docs/tutorials/rolling_alice/0000_architecting_alice#what-is-alice) please use this thread as a way to communicate to others
...
- References
  - This thread in `git grep -i` friendly format: https://github.com/dffml/dffml/tree/main/docs/discussions/alice_engineering_comms
  ...
  - https://github.com/dffml/dffml/blob/main/docs/tutorials/rolling_alice/0000_forward.md
  - https://github.com/dffml/dffml/blob/main/docs/tutorials/rolling_alice/0000_preface.md
...
- Any time (it's a game)
  - We find something we need to complete #1369 that was just completed by someone else
    - Paste `![chaos-for-the-chaos-god](https://github.com/dffml/dffml/assets/5950433/636969a1-1f0f-4c96-8812-f10fa403e79c)`
...
> ![alice-looking-at-the-matrix](https://github.com/dffml/dffml/assets/5950433/6817a805-0601-4443-8927-6ae7739f63d3)
> Source: unknown
